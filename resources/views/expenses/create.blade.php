<x-app-layout>
    ...
    <div class="max-w-xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
            <form method="POST" action="{{ route('colocations.expenses.store', $colocation) }}" class="space-y-5">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input id="date" name="date" type="date" value="{{ old('date', date('Y-m-d')) }}" required
                ...
                <div>
                    ...
                    <select id="category_id" name="category_id"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none text-gray-700">
                ...
                <div>
                    ...
                    <select id="paid_by" name="paid_by" required
                        ...
                        @foreach($members as $member)
                            <option value="{{ $member->id }}" @selected(old('paid_by', Auth::id()) == $member->id)>{{ $member->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="flex gap-3 pt-2">
                    <a href="{{ route('colocations.expenses.index', $colocation) }}" class="flex-1 text-center bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2.5 rounded-xl transition">
                        Cancel
                    </a>
